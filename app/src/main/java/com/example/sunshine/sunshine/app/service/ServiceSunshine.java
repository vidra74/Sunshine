package com.example.sunshine.sunshine.app.service;
...
import com.example.sunshine.sunshine.app.Utility;
...
/**
 * Created by Korisnik on 16.7.2015..
 */
public class ServiceSunshine extends IntentService {

    public static final String PREFERRED_LOCATION = "lqe";
    private final String LOG_TAG = ServiceSunshine.class.getSimpleName();
    private Context mContext;

    @Override
    protected void onHandleIntent(Intent intent) {
        Log.d(LOG_TAG, "Počeo servis");
        if (!intent.hasExtra(PREFERRED_LOCATION)) {
            return;
        }
        String locationQuery = intent.getStringExtra(PREFERRED_LOCATION);
     ...
     */
    public ServiceSunshine() {
        super("ServiceSunshine");
    }
    ...
    static public class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Intent sendIntent = new Intent(context, ServiceSunshine.class);
            sendIntent.putExtra(PREFERRED_LOCATION, intent.getStringExtra(PREFERRED_LOCATION));
