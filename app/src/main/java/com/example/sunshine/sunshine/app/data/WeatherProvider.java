package com.example.sunshine.sunshine.app.data;
        ...
        try {
            ...
            switch (match) {
                case WEATHER: {
                    ...
                    count_deleted_rows = db.delete(WeatherContract.WeatherEntry.TABLE_NAME, selection, selectionArgs);
                    break;
                }
                case LOCATION: {

                    count_deleted_rows = db.delete(WeatherContract.LocationEntry.TABLE_NAME, selection, selectionArgs);
                    break;
                }
                default:
                    throw new UnsupportedOperationException("Unknown uri: " + uri);
        ...
        try {
            ...
            switch (match) {
                case WEATHER: {
                    ...
                    count_updated_rows = db.update(WeatherContract.WeatherEntry.TABLE_NAME, values, selection, selectionArgs);
                    break;
                }
                case LOCATION: {

                    count_updated_rows = db.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection, selectionArgs);
                    break;
                }
                default:
                    throw new UnsupportedOperationException("Unknown uri: " + uri);
